...
Run the distributed tests with ≥ 4 GPUs:
    ...
    torchrun --nproc_per_node=4 tests/models/test_diffusers_ulysses.py
"""
...
def test_diffusers_ulysses_fwd(sp_size):
    """
    ...
    _diffusers_ulysses_fwd(sp_size=sp_size, dp_size=dp_size)


def _diffusers_ulysses_fwd(sp_size: int, dp_size: int):
...
@pytest.mark.parametrize("sp_size", [2, 4])
def test_diffusers_ulysses_fwd_bwd(sp_size):
    """
    ...
    dp_size = world_size // sp_size
    _diffusers_ulysses_fwd_bwd(sp_size=sp_size, dp_size=dp_size)


def _diffusers_ulysses_fwd_bwd(sp_size: int, dp_size: int):
...
@pytest.mark.parametrize("sp_size", [2, 4])
def test_diffusers_ulysses_fwd_bwd_fsdp(sp_size):
    """
    ...
    dp_size = world_size // sp_size
    _diffusers_ulysses_fwd_bwd_fsdp(sp_size=sp_size, dp_size=dp_size)


def _diffusers_ulysses_fwd_bwd_fsdp(sp_size: int, dp_size: int):
    """
